var editarDataUser = function (tbody, table ) { 
    ...
    $(tbody).on("click", "button.buttonEditarUsuarios", function(){
      ...
      Swal.fire({
        ...
        '<img src="./vistas/dist/img/users/user.jpg" class="img-user-mod" alt="Girl in a jacket" width="60" height="80">'+
        ...
        '<div class="row">'+
            ...
            '<input type="text" class="form-control" id="name-input-modal" value="'+ nombre +'" name="name-input-editaruser" placeholder="Nombre" autocomplete="off">'+
       ...
       '<div class="col-6">'+
        ...
        '<input type="text" value="'+ apellido +'" name="lastname-input-editaruser" class="form-control" placeholder="Apellido">'+
        '</div>'+
        '</div>'+
            ...
            '<input type="text" class="tienda-span-modal-mto form-control" value="'+ user +'"  id="tienda-cliente" name="user-input-editaruser" placeholder="Usuario">'+
        '</div>'+
            '</div>'+
            ...
            '<input type="text" class="form-control" value="'+ fecha +'"  name="date-input-editaruser">'+
            '</div>'+
            '</div>'+
            ...
            '<input type="text" class="form-control" value="'+ edad +'"  name="date-input-editaruser">'+
            '</div>'+
            '</div>'+
