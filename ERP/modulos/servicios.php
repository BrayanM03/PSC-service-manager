            ...
            <div class="card container-fluid" style="padding:20px; ">
              <div class="row" style="">
                <div class="col-md-10 mb-2" >
                    <h4 class="m-auto" style="margin:auto">Inventario de servicios PSC</h4>
                    <p>Categoria de Servicios</p>
                </div>
                <div class="col-md-2">
                  <div class="btn btn-primary align-self-start ml-5 mb-4 mt-3" onclick="agregarServicio();">
                    Agregar servicio
                  </div>
                </div>
              </div>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQrMb4s7ZOdauHnUtxwoG2vI5DkLtS3qm9Ekf" crossorigin="anonymous"></script>
  ...
  <script src="../script/inventario/inventario-servicios.js"></script>
