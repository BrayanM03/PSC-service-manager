    ...
    <div class="tab-content" >
      ...
      <div class="content-wrapper" id="v-pills-comp" style="background-color: #E0E0E0;">
        ...
        <div class="conta" style="display:flex; flex-direction: column; justify-content:center;">
          ...
          <div id="contenido-panel" class="container-fluid" style="width:90%; height: auto; margin:auto;" >
            <div class="card container-fluid" style="padding:20px; ">
              <div class="row" style="">
                <div class="col-md-10 mb-2" >
                    <h4 class="m-auto" style="margin:auto">Inventario de productos PSC</h4>
                    <p>Categoria de computadoras</p>
                </div>
                <div class="col-md-2">
                  <div class="btn btn-primary align-self-start ml-5 mb-4 mt-3" onclick="agregarProducto();">
                    Agregar producto
                  </div>
                </div>
              </div>
                  ...
                  <table class="table table-striped table-bordered table-hover mb-2" id="productos-inv" style="width:100%;">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQrMb4s7ZOdauHnUtxwoG2vI5DkLtS3qm9Ekf" crossorigin="anonymous"></script>
  ...
  <script src="../script/inventario/inventario-comp.js"></script>
