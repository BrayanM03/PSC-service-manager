...
<head>
  ...
  <title>Proveedpres | PSC | ERP manager </title>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" id="v-pills-tab" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open mt-3">
              ...
              <li class="nav-item">
                  <a href="mis-proveedores.php" id="nav-refacciones" class="nav-link active">
                    <i class="fas fa-user-tag nav-icon"></i>
                    <p>Proveedores</p>
                  </a>
                </li>
            ...
            <div class="card container-fluid" style="padding:20px; ">
              <div class="row" style="">
                <div class="col-md-10 mb-2" >
                    <h4 class="m-auto" style="margin:auto">Proveedores de PSC</h4>
                    <p>Esta es la lista de proveedores registrados</p>
                </div>
                <div class="col-md-2">
                  <div class="btn btn-primary align-self-start ml-5 mb-4 mt-3" onclick="agregarProveedor();">
                    Agregar proveedor
                  </div>
                </div>
              </div>
                  ...
                  <table class="table table-striped table-bordered table-hover mb-2" id="proveedores-lista" style="width:100%;">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQrMb4s7ZOdauHnUtxwoG2vI5DkLtS3qm9Ekf" crossorigin="anonymous"></script>
  ...
  <script src="../script/proveedores/mis-proveedores.js"></script>
