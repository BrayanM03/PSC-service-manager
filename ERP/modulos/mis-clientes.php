...
<head>
  ...
  <link rel="stylesheet" href="../estilos/inventario.css">
    <link rel="stylesheet" href="../estilos/estilos-toggle-switch.css">
            ...
            <div class="card container-fluid" style="padding:20px; ">
              <div class="row" style="">
                <div class="col-md-10 mb-2" >
                    <h4 class="m-auto" style="margin:auto">Clientes de PSC</h4>
                    <p>Esta es la lista de clientes registrados</p>
                </div>
                <div class="col-md-2">
                  <div class="btn btn-primary align-self-start ml-5 mb-4 mt-3" onclick="agregarCliente();">
                    Agregar cliente
                  </div>
                </div>
              </div>
                  ...
                  <table class="table table-striped table-bordered table-hover mb-2" id="clientes-lista" style="width:100%;">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.bundle.min.js" integrity="sha384-JEW9xMcG8R+pH31jmWH6WWP0WintQrMb4s7ZOdauHnUtxwoG2vI5DkLtS3qm9Ekf" crossorigin="anonymous"></script>
  ...
  <script src="../script/clientes/mis-clientes.js"></script>
